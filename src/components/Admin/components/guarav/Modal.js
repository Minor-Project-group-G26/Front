                  ...
                  <ModalWrapper showModal={showModal}>
                      {/* <ModalImg src={require('./Admin.jpg')} alt="Image"/> */}
                        ...
                        <ModalContent>
                            ...
                            <p className="details">Link :-<span> {Data.Link} </span></p>
                            <p className="down">Actor :-<span> {Data.Actor.toString()} </span></p>
                            <p className="down">Directors :-<span> {Data.Director.toString()} </span></p>
                            <p className="down">Producers :-<span> {Data.Producer.toString()} </span></p>
